    ...
    try {
      switch (req.body.type) {
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will summarize text or sentence or paragraph. It must be summarized in such a way that it must be informative.',
              },
        ...
        case 'NaturalLanguagetoPython':
          ...
          console.log(EnglishToPython, 'python');
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the test code for the complete python code given and try to fix the complete code with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Doc String for python code for the question asked or python code pasted with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the SQL query for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will get the explain the python code what exactly it is doing and also return its time complexity.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will get the time complexity of code with perfect explanation.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  "You are a helpful AI assistant, where you will convert from one programming language to another. You'll be provided the code that you have to convert to another prgramming langauge. Once I've provided the code, you have to generate the equivalent code for the requested programming language.              ",
              },
              { role: 'user', content: Text },
            ],
            ...
            messages: [
              {
                role: 'system',
                content:
                  "You are a helpful AI assistant, where you can convert the PySpark code to SQL queries. You'll be provided the PySpark code that you have to convert to SQL. Once I've provided the code, you hve to generate the equivalent SQL query for you. You are here to assist you with converting your PySpark code to SQL.",
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  "You are a helpful AI assistant, where you can convert the Pandas code to PySpark code. You'll be provided the Pandas code that you have to convert to PySpark. Once I've provided the code, you have to generate the equivalent PySpark code for you. You are here to assist you with converting your Pandas code to PySpark.",
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will parse the unstructured data into structured format.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the JavaScript code for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will explain the code and also return the time complexity for the code given or the questions asked.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will extract the important information from the reference paragraphs or the sentences and explain what you understood i.e. meaningful insights.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will extract the important numerical information from the reference paragraphs or the sentences, then return the meaningful insights.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the perfect content for the questions asked.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will remove the Plagiarism and rewrite the complete paragraph or sentences perfectly without losing any information.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  ' You are a helpful AI assistant, where you will return the answer the aptitude questions asked with the explanation of why the returned answer is correct.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will extract the keywords from the reference paragraph or sentences and explain what those keywords are.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will generate the Excel Formula for the question asked.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will generate 10 MCQ questions with options from the reference paragraphs or sentences.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will generate 10 questions from the reference paragraphs or sentences.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Essay Writing for the question asked.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the VBA code for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Postgres SQL query for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Oracle SQL query for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the AnsiSQL query for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Store Procedure in SQL for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will write the Views in SQL for the question asked with the explanation of every line.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  "You are a helpful AI assistant, where you can convert the JavaScript code to Python code. You'll be provided the JavaScript code that you have to convert to Python. Once I've provided the code, you have to generate the equivalent Python code for you. You are here to assist you with converting your JavaScript code to Python.",
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant, where you will return the answers for the questions asked from the paragraph of sentences you entered for reference.',
              },
            ...
            messages: [
              {
                role: 'system',
                content:
                  'You are a helpful AI assistant where you will be returing the answers for whatever the questions aksed.',
              },
